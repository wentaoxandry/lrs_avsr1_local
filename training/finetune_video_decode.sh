...
# decoding parameter
recog_model=model.acc.best #model.last10.avg.best	# set a model to be used for decoding: 'model.acc.best' or 'model.loss.best'
n_average=10
...
ln -rsf  local/training/finetunevideo/e2e_asr_transformerdecode.py ${MAIN_ROOT}/espnet/finetunevideo/e2e_asr_transformer.py  || exit 1;
